                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <fieldset>
                                    ...
                                    <input type="text" name="contest" class="searchText" placeholder="Contest Name..."
                            ...
                            <div class="col-lg-4">
                                <fieldset>
                                    ...
                                    <select name="category" class="form-select" aria-label="Choose a category"
                                            id="category" onchange="this.form.click()">
                                        <option selected>Choose a category</option>
                                        <option type="checkbox" name="Nature" value="Nature">Nature Photography (220
                                            Contests)
                                        </option>
