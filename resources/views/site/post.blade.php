                ...
                <div class="col-lg-12">
                    <div class="main-content">
                        ...
                        <p>SnapX Photography is a professional website template with 5 different HTML pages for maximum
                            customizations. This is based on Bootstrap v5.1.3 CSS framework. Please visit TemplateMo
                            website to see more CSS templates.</p>
                        <p>You are allowed to 100% freely use this SnapX Template for your commercial websites. You are
                            not allowed to redistribute the template ZIP file on any other Free CSS Template collection
                            websites.</p>
                        <h6 class="second-title">Picture Should Not Have</h6>
                        <p>We hope this template is very useful for your website development. If you wish to <a
                                rel="nofollow" href="https://templatemo.com/contact" target="_blank">support
                                TemplateMo</a>, you may make a small amount of donation via PayPal.</p>
                        <p>If you need the PSD source files of this template, please feel free to contact TemplateMo.
                            Our supporters are welcome.</p>
